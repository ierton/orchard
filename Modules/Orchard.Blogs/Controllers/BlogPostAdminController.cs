...
namespace Orchard.Blogs.Controllers {
    ...
    public class BlogPostAdminController : Controller, IUpdateModel {
        ...
        public ActionResult Create(int blogId) {
            ...
            if (!Services.Authorizer.Authorize(Permissions.EditOwnBlogPost, blog, T("Not allowed to create blog post")))
        ...
        private ActionResult CreatePOST(int blogId, bool publish = false) {
            ...
            if (!Services.Authorizer.Authorize(Permissions.EditOwnBlogPost, blog, T("Couldn't create blog post")))
                return new HttpUnauthorizedResult();
            ...
            if (publish) {
                if (!Services.Authorizer.Authorize(Permissions.PublishOwnBlogPost, blog.ContentItem, T("Couldn't publish blog post")))
                    return new HttpUnauthorizedResult();
